            ...
            <form action="{{ route('lokasi-budidaya.store') }}" method="POST">
                ...
                <div class="grid grid-cols-2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kabupaten_kota" id="kabupaten_kota" class="form-control @error('kabupaten_kota') is-invalid @enderror" value="{{ old('kabupaten_kota') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kecamatan" id="kecamatan" class="form-control @error('kecamatan') is-invalid @enderror" value="{{ old('kecamatan') }}">
                        @error('kecamatan')
                            <div class="text-danger text-sm mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="desa" id="desa" class="form-control @error('desa') is-invalid @enderror" value="{{ old('desa') }}">
                        @error('desa')
                            <div class="text-danger text-sm mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="number" step="0.01" min="0" name="volume" id="volume" class="form-control @error('volume') is-invalid @enderror" value="{{ old('volume', 0) }}" required>
                        </div>
                        @error('volume')
                            <div class="text-danger text-sm mt-1">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="number" step="0.01" min="0" name="hasil_panen_kg" id="hasil_panen_kg" class="form-control @error('hasil_panen_kg') is-invalid @enderror" value="{{ old('hasil_panen_kg', 0) }}" required>
                        </div>
