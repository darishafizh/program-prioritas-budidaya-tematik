...
<div class="card shadow-sm border-0" style="border-radius: 12px;">
    <div class="card-body">
        ...
        <div class="dt-card-header">
            <h4 class="dt-card-title">Daftar Kuesioner Masyarakat</h4>
            <a href="{{ route('masyarakat.create') }}" class="btn-tambah-data">
                ...
                <tr>
                    ...
                    <td>
                        <div class="table-actions">
                            ...
                            <form id="delete-form-{{ $survey->hashid ?? $survey->id }}" action="{{ route('masyarakat.destroy', $survey) }}" method="POST" style="display:inline;">
                                @csrf @method('DELETE')
